...
const firebaseConfig = {
  apiKey: "AIzaSyCPGT4tPtuXwlYvpjiz0i3PaZ__RlCLdLs",
  authDomain: "dropboxclone-fd521.firebaseapp.com",
  databaseURL: "https://dropboxclone-fd521-default-rtdb.firebaseio.com",
  projectId: "dropboxclone-fd521",
  storageBucket: "dropboxclone-fd521.appspot.com",
  messagingSenderId: "25296063416",
  appId: "1:25296063416:web:ccdf21bda39c52fb415d4d",
  measurementId: "G-HLYWKPRJSH"
};
...
firebase.initializeApp(firebaseConfig);
    ...
    uploadTask(files){
        ...
        [...files].forEach(file =>{
           ...
           promises.push(new Promise((resolve, reject)=>{
            ...
            formData.append('inpute-file', file);
        ...
        return Promise.all(promises); //verifica todo mundo
    ...
    uploadProgress(event,file){
        ...
        this.timeleftEl.innerHTML = this.formtTimeToHuman(timeleft);

    }

    formtTimeToHuman(duration){
